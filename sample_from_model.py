...
def meanfield_run():
    ...
    run(flexible_config = {"jit": args.jit, "dataset_name": "HCP_dummy", "problem_name": "HCP", "edge_updates": True, "mode_node_edge": "edge", "N_anneal": args.N_anneal[0], "load_wandb_id": "pwl858iz","n_random_node_features": 16, "n_diffusion_steps": args.n_diffusion_steps[0], "minib_diff_steps": args.minib_diff_steps, "minib_basis_states": args.minib_basis_states, "N_basis_states": args.n_basis_states[0], "train_mode": args.train_mode}, overwrite = True) # "load_wandb_id": "oz5t74ww"
...
def run( flexible_config, overwrite = True):
    ...
    plot_graph(graph, graph_batch["graphs"][0].graph.globals["node_types"][0], 0)
